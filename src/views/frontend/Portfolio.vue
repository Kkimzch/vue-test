    ...
    <section>
        <div class="container pt-40 pb-20 mx-auto text-center">
            ...
            <div class="flex flex-wrap items-center mb-4">
                ...
                <div class="w-full p-4 lg:w-3/12 sm:w-6/12" v-show="isVisible">
                    <a href="#" class="block text-left hover:opacity-75"> 
                        <img src="@/assets/img/img-work-4.webp" class="object-cover w-full h-64"/> 
                        <div class="flex items-center justify-between px-4 py-3 bg-indigo-100">
                            <h5 class="text-base font-semibold text-gray-900">Project 4</h5>
            ...
            <button @click="toggle" class="inline-block px-6 py-2 text-white bg-indigo-600 border-2 border-indigo-600 rounded-md hover:text-indigo-600 hover:bg-indigo-100">ผลงานทั้งหมด</button>
        </div> 
    </section>
</template>
